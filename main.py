...
app = FastAPI(title="Electrician Services API", version="1.0.0")
...
@app.get("/")
def read_root():
    return {"message": "Electrician Services API running"}
...
# --------- Electrician business endpoints ---------
...
def create_inquiry(payload: InquiryCreate):
    try:
        inquiry = Inquiry(**payload.model_dump(), source="website")
